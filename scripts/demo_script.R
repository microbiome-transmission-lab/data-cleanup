...
demo_data<-read.csv("demo_data/Demo/Data/demo_data.csv")
...
write_csv(demo_data_2,"demo_data/Demo/Data/demo_data_2.csv")
...
ggsave(demo_figure, filename= "demo_data/Demo/Figs/demo_figure.png")
